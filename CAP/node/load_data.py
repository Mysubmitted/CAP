...
from torch_geometric.datasets import Planetoid, Flickr, TUDataset, Amazon
...
def load_node_data(dataset_name, data_folder):
    ...
    elif dataset_name in ['photo', 'amazon-photo', 'amazonphoto']:
        dataset = Amazon(root=f'{data_folder}/Amazon', name='Photo')
    else:
